...
<body class="antialiased">
    <div class="container relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="mb-2">
            ...
            <a href="{{ route('datatable.index') }}" class="btn btn-secondary">datatable usuarios</a>
            <a href="{{ route('ajax_datatable.index') }}" class="btn btn-danger">ajax datatable</a>
        </div>
